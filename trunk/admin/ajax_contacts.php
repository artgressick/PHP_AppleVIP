<?
	...
	if(@$_POST['postType'] == "quickInsert") {
		...
		$insertcheck = fetch_database_query("SELECT ID FROM Invites WHERE !bDeleted AND idShow='".$_POST['idShow']."' AND idContact='".$_POST['idContact']."' AND idUser='".$_POST['idUser']."'","Checking for exsiting");
